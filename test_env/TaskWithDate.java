...
public class TaskWithDate {
    ...
    public boolean isDateInLegalForm(String date)
    {
    ...
    public boolean arrMonthsAndDaysInRange(String[] YearMonthDay)
    {
    ...
    public boolean isD1GreaterthanD2(int[] date1, int[] date2)
    {
        int year1 = date1[0];
        int year2 = date2[0];
        int month1 = date1[1];
